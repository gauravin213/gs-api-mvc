...
class GaEcommerceTracking
{
	...
	public function __construct( $ga_id_PARAM, $page_title_PARAM, $debug_PARAM ) {    
		...
		$this->ga_url     = $this->debug ? 'https://ssl.google-analytics.com/debug/collect' : 'http://www.google-analytics.com/collect';
